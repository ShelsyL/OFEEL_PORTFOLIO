...
CREATE TABLE `artcomments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Artcomments_articles1_idx` (`articles_id`),
  CONSTRAINT `fk_Artcomments_articles1` FOREIGN KEY (`articles_id`) REFERENCES `articles` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `workcomments` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Workcomments_works1_idx` (`works_id`),
  CONSTRAINT `fk_Workcomments_works1` FOREIGN KEY (`works_id`) REFERENCES `works` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2021-06-04 14:48:29
