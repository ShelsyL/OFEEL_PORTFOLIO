...
-- -----------------------------------------------------
-- Table `ofeel_portfolio`.`workcomments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ofeel_portfolio`.`workcomments` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_workcomments_works1_idx` (`works_id` ASC),
  CONSTRAINT `fk_workcomments_works1`
...
-- -----------------------------------------------------
-- Table `ofeel_portfolio`.`artcomments`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ofeel_portfolio`.`artcomments` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `pseudo` VARCHAR(45) NOT NULL,
  `content` TEXT NULL,
  `created_at` DATETIME NOT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_artcomments_articles1_idx` (`articles_id` ASC),
  CONSTRAINT `fk_artcomments_articles1`
