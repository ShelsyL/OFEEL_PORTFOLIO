            ...
            <ul class="portfolio-items nopadding-lr isotope list-unstyled">
              <li v-for="work in this.works" :key="work.id" class="col-sm-4 col-xs-12 portfolio-item nopadding-lr apps isotope-item">
                <div class="hover-item">
                  <!-- <img :src="'storage/assets/img/portfolio/' + work.image" class="img-responsive smoothie" alt="work.title"> -->
                  <img :src="'storage/' + work.image" class="img-responsive smoothie" alt="work.title">
                  <div class="overlay-item-caption smoothie"></div>
                  <div class="hover-item-caption smoothie">
                    <div class="vertical-center smoothie">
                      <h3 class="smoothie mb30"><a href="single-portfolio-fullscreen.html" title="view project"></a></h3>
                      <a :href="'storage/assets/img/portfolio/' + work.image" title="View Gallery" class="btn btn-primary lb-link smoothie">Zoom</a>
